...
def run_full():
    ...
    for agent in [DegGreedy_fair, DepRound_fair, EC, NoIntervention]:
        ...
        while len(state.SIR.I1) + len(state.SIR.I2) != 0:
            ...
            infections.append(len(state.SIR.I2)/mont_size)
...
with open(PROJECT_ROOT/"output"/"mont_star_combined_epicurve.json", 'w') as f:
